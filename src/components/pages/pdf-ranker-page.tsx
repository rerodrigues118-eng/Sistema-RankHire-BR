...
function statusColor(status: UploadFile["status"]) {
  ...
  return "text-[#7C3AED] bg-purple-50 border border-purple-200";
}
...
export default function PdfRankerPage({
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto px-4 py-4 font-sans text-slate-800">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-100 pb-5">
        <div>
          <div className="flex items-center gap-3">
            ...
            {currentQuota && (
              <div className="flex items-center gap-2 bg-purple-50/80 border border-purple-100 rounded-full px-3 py-1 text-xs font-semibold text-[#7C3AED]">
          ...
          <button
            ...
            className={`w-full rounded-2xl py-5 px-6 flex items-center justify-between gap-4 transition-all duration-200 border border-dashed text-left group ${
              hasCriteria && !isLimitReached
                ? "border-slate-300 hover:border-[#7C3AED] bg-slate-50/50 hover:bg-purple-50/20 cursor-pointer shadow-2xs"
                : "border-slate-200 bg-slate-100/50 cursor-not-allowed opacity-60"
            }`}
          >
            <div className="flex items-center gap-4 min-w-0">
              <div className="w-10 h-10 rounded-xl bg-purple-100/70 text-[#7C3AED] flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
            ...
            <div className="flex-shrink-0">
              <span className="px-4 py-2 bg-white text-[#7C3AED] font-bold text-xs border border-purple-200 rounded-xl shadow-xs group-hover:bg-[#7C3AED] group-hover:text-white transition-all">
                + Selecionar Arquivos
              </span>
            </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3 flex-shrink-0">
                          {firstTag && (
                            <span className="hidden sm:inline-block bg-purple-50 text-[#7C3AED] border border-purple-100 px-2.5 py-0.5 rounded-full text-[11px] font-semibold truncate max-w-[130px]">
                              {firstTag}
                            </span>
                          )}
      ...
      {activeTab === "funil" && (
        <div className="space-y-6">
          <div className="flex items-start gap-3 bg-purple-50/70 border border-purple-100 rounded-2xl p-4">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-slate-100 pb-4">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-2 bg-purple-50 text-[#7C3AED] hover:bg-purple-100 border border-purple-200 rounded-xl text-xs font-semibold transition-all cursor-pointer"
                >
              ...
              <div className="flex flex-wrap gap-2">
                {suggestionsToShow.map((s) => (
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-slate-200 hover:border-[#7C3AED] hover:bg-purple-50 text-slate-700 hover:text-[#7C3AED] rounded-full text-xs font-semibold transition-all cursor-pointer"
                  >
